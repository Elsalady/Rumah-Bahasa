...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::statement("ALTER TABLE profil ADD CONSTRAINT profil_kategori_check CHECK (kategori::text = ANY (ARRAY['sejarah', 'visi_misi', 'tugas_fungsi', 'struktur', 'volunteer', 'gambaran_umum', 'sasaran']::text[]))");
    }
