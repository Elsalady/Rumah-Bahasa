...
<section class="py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <span class="text-sm font-semibold text-primary-600 uppercase tracking-wider">Kontak</span>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto">
            ...
            <div class="space-y-6">
                <div class="card-3d p-6 flex items-start gap-5">
                    <div class="w-12 h-12 bg-gradient-to-br from-primary-400 to-primary-500 rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg shadow-primary-200">
                ...
                <div class="card-3d p-6 flex items-start gap-5">
                    <div class="w-12 h-12 bg-gradient-to-br from-emerald-400 to-emerald-500 rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg shadow-emerald-200">
                        <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="card-3d p-6 flex items-start gap-5">
                    <div class="w-12 h-12 bg-gradient-to-br from-violet-400 to-violet-500 rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg shadow-violet-200">
                        <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <form action="{{ route('kontak.kirim') }}" method="POST" class="space-y-5">
                        ...
                        <div>
                            ...
                            <input type="text" name="nama" id="nama" required
                                class="w-full px-4 py-2.5 bg-gray-50/60 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500/20 focus:border-primary-400 focus:bg-white outline-none transition-all @error('nama') border-red-300 @enderror"
                        ...
                        <div>
                            ...
                            <input type="email" name="email" id="email" required
                                class="w-full px-4 py-2.5 bg-gray-50/60 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500/20 focus:border-primary-400 focus:bg-white outline-none transition-all @error('email') border-red-300 @enderror"
                        ...
                        <div>
                            ...
                            <input type="text" name="subjek" id="subjek"
                                class="w-full px-4 py-2.5 bg-gray-50/60 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500/20 focus:border-primary-400 focus:bg-white outline-none transition-all"
                        ...
                        <div>
                            ...
                            <textarea name="pesan" id="pesan" rows="5" required
                                class="w-full px-4 py-2.5 bg-gray-50/60 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500/20 focus:border-primary-400 focus:bg-white outline-none transition-all @error('pesan') border-red-300 @enderror"
                                placeholder="Ketik pesan Anda...">{{ old('pesan') }}</textarea>
                            @error('pesan') <p class="text-red-500 text-sm mt-1">{{ $message }}</p> @enderror
                        </div>
                        <button type="submit"
                            class="w-full px-6 py-3 bg-gradient-to-r from-primary-600 to-primary-500 text-white font-medium rounded-xl hover:shadow-lg hover:shadow-primary-500/20 hover:-translate-y-0.5 transition-all">
                            Kirim Pesan
                        </button>
                    </form>
                </div>
