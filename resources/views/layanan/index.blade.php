...
<section class="py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="card-3d p-8">
                <div class="icon-3d w-14 h-14 bg-gradient-to-br from-orange-400 to-orange-500 text-white shadow-lg shadow-orange-200 mb-5">
                    <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="card-3d p-8">
                <div class="icon-3d w-14 h-14 bg-gradient-to-br from-rose-400 to-rose-500 text-white shadow-lg shadow-rose-200 mb-5">
                    <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="card-3d p-8">
                <div class="icon-3d w-14 h-14 bg-gradient-to-br from-teal-400 to-teal-500 text-white shadow-lg shadow-teal-200 mb-5">
                    <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
