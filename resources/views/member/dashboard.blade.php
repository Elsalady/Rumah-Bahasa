                                            ...
                                            @foreach($jadwalMingguan[$hari] as $j)
                                                <div style="display:flex;align-items:center;gap:10px;padding:10px 14px;background:#f8fafc;border:1px solid var(--gray-100);border-radius:10px;margin-bottom:6px;flex-wrap:wrap;">
                                                    ...
                                                    <div style="display:flex;align-items:center;gap:5px;flex-wrap:wrap;">
                                                        ...
                                                        <a href="https://sipus.surabaya.go.id/pendaftaranonlineanggota" target="_blank" rel="noopener" title="Buka pendaftaran anggota SIPUS untuk absensi kelas" style="display:inline-flex;align-items:center;gap:4px;font-size:10px;font-weight:700;padding:4px 10px;border-radius:50px;background:#0167a2;color:#fff;border:1px solid #0167a2;text-decoration:none;cursor:pointer;">
